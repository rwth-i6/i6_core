...
class DumpRecordingPathsJob(Job):
    ...
    def __init__(self, corpus_file: tk.Path, dump_durations: bool = False):
        r"""
        ...
        :param dump_durations: Whether to dump the durations of the audios along with the audio list.
            The `out_audio_durations` output file contains `<audio>\t<duration>` per audio/duration pair.
        """
